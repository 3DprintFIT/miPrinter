			...
			difference(){
				union(){
					//Base block
						...
						translate(v = [-7, 18.5, 0]) cube(size = [49,20,5], center = true);
						translate(v = [-16.4, -6, 0]) rotate(a=[0,0,17]) cylinder(h = 5, r=35, $fn=5, center=true);
						translate(v = [-2.4, -6, 0]) rotate(a=[0,0,15]) cylinder(h = 5, r=35, $fn=5, center=true);
						translate(v = [-7, -31, 0]) cylinder(h = 5, r=m4_nut_diameter/2+2, $fn=6, center=true);	
				...
				if(linear_bearings){
					...
					translate(v = [25.01,30.01,5.01])lm8uu_bearing_cut();	
					translate(v = [-39.01,30.01,5.01])lm8uu_bearing_cut();
					translate(v = [-49,-30,0]) rotate(a=[0,0,20]) cube(size = [30,70,10], center = true);
				}
				...
				if(snap_in_mount){
					...
					//removing some mass	
					translate(v = [-7, 36, 0]) cylinder(h = 9, r=14, $fn=6, center=true);	
		
					// Hotend hole
					translate(v = [-7, -6, 0]) cylinder(h = 20, r=20, $fn=20, center=true);
